            ...
            ?>
                <div class="post_img">
                    ...
                    <div class="post_img_overlay">
                        ...
                        <div class="icon_fullscreen" data-title="<?php the_title(); ?>" data-image="<?php echo esc_attr(get_the_post_thumbnail_url(get_the_ID())); ?>" data-reference="<?php the_field('reference'); ?>" data-categorie="<?php the_field('categories') ?>">
                            <img src="
