            ...
            <div class="post_links">
                <div class="prev_post_img">
                    <?php if (!empty($prev_post)) :
                            ...
                            ?>
                    <a id="prevLink" href="<?php echo get_permalink($prev_post); ?>" rel="prev"
                        data-image="<?php echo $prev_image; ?>"><img
                            src="<?php echo get_template_directory_uri(); ?>/assets/img/prev_arrow.png"></a>
                    <?php endif; ?>
                </div>
                <div class="next_post_img">
                    <?php if (!empty($next_post)) :
                            ...
                            ?>
                    <a id="nextLink" href="<?php echo get_permalink($next_post); ?>" rel="next"
