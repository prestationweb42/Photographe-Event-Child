        ...
        <main id="main_single_photo_page">
            ...
            <section class="section_post_other_imgs">
                ...
                <article class="post_other_imgs_container">
                    ...
                    wp_reset_postdata() ?>
                    <div class="post_other_imgs">
                        <img src="http://localhost:8888/PhotographeEvent/wp-content/uploads/2023/08/nathalie-4-683x1024.webp" alt="photo 4">
                    </div>
                    <div class="post_other_imgs">
                        <img src="http://localhost:8888/PhotographeEvent/wp-content/uploads/2023/08/nathalie-1-768x512.webp" alt="photo 1">
                    </div>
                </article>
